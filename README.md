...
|---|---|---|
| Nombres de archivo "Mi Pagina De Notas.HTML" y "Estilos Del Sitio.CSS". | Tenían espacios y mayúsculas sueltas, lo que no sigue la convención de nombres de archivo. | Renombre los archivos a "calculadora-notas.html" y "estilos.css", en kebab-case. |
